...
const Page_Cycle: React.FC = () => {
    return (
        <div style={{padding: "24px"}}>
            <div style={{marginBottom: "32px"}}>
                <Title>🏆 Cycle 记录排名</Title>
                <Paragraph>
                    查看 Cycle 项目的世界记录和排名情况。可以按轮次（预赛/决赛）和级别（初级/中级/高级）筛选结果。
                </Paragraph>
            </div>
            ...
            <Space direction="vertical" size="large" style={{width: "100%"}}>
                ...
                <RecordRankingTable event="Cycle" title="Cycle 详细排名" />
            </Space>
        </div>
    );
};

export default Page_Cycle;
