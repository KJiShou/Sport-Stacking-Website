...
function Header(props) {
    ...
    function renderHeaderLabel() {
        ...
        if (mode === 'date' || mode === 'week') {
            var yearNode = (react_1.default.createElement("span", { className: prefixCls + "-header-label", onClick: function () { return onChangePanel('year'); } }, value.format(yearFormat || 'YYYY')));
            var monthNode = (react_1.default.createElement("span", { className: prefixCls + "-header-label", onClick: function () { return onChangePanel('month'); } }, value.format(monthFormat || 'MM')));
