...
function Header(props) {
    ...
    function renderHeaderLabel() {
        ...
        if (mode === 'date' || mode === 'week') {
            var yearNode = (React.createElement("span", { className: prefixCls + "-header-label", onClick: function () { return onChangePanel('year'); } }, value.format(yearFormat || 'YYYY')));
            var monthNode = (React.createElement("span", { className: prefixCls + "-header-label", onClick: function () { return onChangePanel('month'); } }, value.format(monthFormat || 'MM')));
